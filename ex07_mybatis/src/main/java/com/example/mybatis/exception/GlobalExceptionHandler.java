...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleException(Exception e) {
    ErrorResponse errorResponse = ErrorResponse.of(ErrorCode.INTERNAL_SERVER_ERRER);
    return new ResponseEntity<>(errorResponse, ErrorCode.INTERNAL_SERVER_ERRER.getStatus());
  }
}
